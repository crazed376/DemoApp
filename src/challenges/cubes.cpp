...
namespace GLTest {
    namespace Cubes {
        ...
        static std::array<u32, 36> cubeElements = {
        ...
        void createDefaultCube() {
            ...
            for(u16 vertexIndex=0; vertexIndex<cubeElements.size(); vertexIndex++) {
            ...
            // Set up and enable attribute 3 (OpenGL 3.3 method)
            glVertexAttribPointer(3, 3, GL_FLOAT, GL_FALSE, sizeof(Vertex), (void*)offsetof(Vertex, tangent));
            glEnableVertexAttribArray(3);

            // Set up and enable attribute 4 (OpenGL 3.3 method)
        ...
        void drawCube(const glm::vec3& position, const Texture& texture) {
            ...
            texturedCubeShader.uploadMat4("u_transform", transform);
            ...
            // Upload texture slot 0 to our uniform u_texture
            texturedCubeShader.uploadInt("u_texture", textureSlot);
        ...
        Texture createTexture(const std::string& filepath, bool pixelated=false) {
            ...
            u8* pixels = stbi_load(res.filepath.c_str(), &res.width, &res.height, &res.numChannels, 0);
        ...
        void update(float dt) {
            ...
            // Rotate the eye a little bit each frame
            ...
            texturedCubeShader.uploadMat4("u_view", view);
            texturedCubeShader.uploadMat4("u_projection", projection);
            ...
            texturedCubeShader.uploadInt("u_normalTexture", 1);
            ...
            for(u16 i=0; i<cubePositions.size(); i++) {
